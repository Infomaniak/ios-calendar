...
struct EventDraftValidator {
    enum ValidationError: LocalizedError, Hashable {
        case titleTooLong
    ...
    static let maximumTitleCharacterCount = 1000
    static let maximumDescriptionCharacterCount = 5000
    static let maximumAttendeeCount = 100

    func validate(_ draft: EventDraft) -> Set<ValidationError> {
